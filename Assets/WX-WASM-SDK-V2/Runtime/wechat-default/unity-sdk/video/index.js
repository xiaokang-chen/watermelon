    ...
    if (isWebVideo) {
        ...
        videoDecoder.on('start', (res) => {
            if (isDebug) {
                ...
                console.warn('videoInstance.pauseTime',videoInstance.pauseTime, videoInstance.paused)
            }
            if (!videoInstance.isReady) {
                ...
                if (videoInstance.paused && 0 < videoInstance.pauseTime) {
                    videoInstance.seek(videoInstance.pauseTime*1000);
                    videoInstance.pauseTime = 0;
                }
            }
        ...
        videoDecoder.on('stop', (res) => {
            ...
            videoInstance.pauseTime = videoInstance.currentTime;
