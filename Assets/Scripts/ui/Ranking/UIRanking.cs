...
public class UIRanking : MonoBehaviour
{
    ...
    public RankKeyType rankKeyType = RankKeyType.ScoreRank;
    ...
    public void PopIn()
    {
        if (RankKeyType.FeelingsRank == rankKeyType)
        {
            score.text = DataStorageMgr.Instance.Feelings.ToString();
        }
        else
        {
            score.text = DataStorageMgr.Instance.WatermelonScore.ToString();
        }
